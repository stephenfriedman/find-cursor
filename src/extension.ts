...
'use strict'
import { commands, ExtensionContext, window, workspace, Range, Position, TextEditorRevealType} from 'vscode'
...
export async function activate(context: ExtensionContext) {
    ...
    function setHighlight(cursorLine, updateAllVisibleEditors=false) {
        try {
